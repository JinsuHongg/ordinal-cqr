...
### Image-available split distributions

The model operates only on retained rows with the complete required image stack.
The following are therefore the canonical distributions for training, validation,
calibration, and future-test evaluation. Counts and percentages were generated by
intersecting each filtered index CSV with the SuryaBench Zarr timestamps; the audit
is stored in `outputs/conference_v0_3/solar_flare/data_audits/`.

| Split | Image-available N | FQ/A (0) | B (1) | C (2) | M (3) | X (4) |
|---|---:|---:|---:|---:|---:|---:|
| Training | 42,292 | 9,369 (22.15%) | 11,067 (26.17%) | 16,754 (39.62%) | 4,571 (10.81%) | 531 (1.26%) |
| Validation | 2,255 | 344 (15.26%) | 772 (34.24%) | 878 (38.94%) | 239 (10.60%) | 22 (0.98%) |
| Calibration | 3,605 | 626 (17.36%) | 960 (26.63%) | 1,352 (37.50%) | 626 (17.36%) | 41 (1.14%) |
| Future test | 27,620 | 4,952 (17.93%) | 4,403 (15.94%) | 9,897 (35.83%) | 7,420 (26.86%) | 948 (3.43%) |

These image-available counts must be used for training, model-selection,
calibration, test-performance, and coverage summaries. The larger source-manifest
counts remain only provenance for the target-label filtering policy; they are not
the populations seen by the model.
